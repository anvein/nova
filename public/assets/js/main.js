    ...
    var $window = $(window);
        ...
        $window.on('scroll', function() {
            ...
            if (scroll <= 50) {
                ...
                logowhitedark.attr('src', '/assets/img/logos/logo-white.png');

                logo2.attr('src', logo2.attr('data-logo-light'));
                ...
                logodefault.attr('src', '/assets/img/logos/logo.png');
                logowhite.attr('src', '/assets/img/logos/logo-white.png');
                logowhitedark.attr('src', '/assets/img/logos/logo-dark.png');

                logo2.attr('src', logo2.attr('data-logo-dark'));
